...
public class InventoryMangement extends javax.swing.JFrame {
    ...
    public InventoryMangement() {
        initComponents();
        //Check if user is logged in (for system error situation)
        if (Session.getUsername() == null) {
            JOptionPane.showMessageDialog(this, "No user logged in! Redirecting to login.");
            setVisible(false);
            // TODO: Redirect to login page when available from teammates
            // e.g., new Login().setVisible(true);
            return;
        }
        lbl_username.setText(Session.getUsername()); // Set username directly
        loadItemTable();
    }
    ...
    private void initComponents() {
        ...
        lbl_username.setIcon(new javax.swing.ImageIcon("C:\\study\\sem3\\prg2201 object-oriented programming\\group asg\\icon\\profile icon.png")); // NOI18N
        lbl_username.setOpaque(true);
        getContentPane().add(lbl_username, new org.netbeans.lib.awtextra.AbsoluteConstraints(650, 20, 170, 50));
